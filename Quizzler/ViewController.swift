...
class ViewController: UIViewController {
    ...
    @IBAction func answerButtonPressed(_ sender: UIButton) {
        ...
        let actualAnser = actualQuestion.answer //2D arrayde cevabin bulundugu yer
    ...
    @objc func updateUI(){
        questionLabel.text = quiz[questionNumber].question //2D arrayin ilk elemani yani sorunun bulundugu yer.
        trueButton.backgroundColor = UIColor.clear
        falseButton.backgroundColor = UIColor.clear
        progressBar.progress = Float(questionNumber + 1 ) / Float(quiz.count) //question number 0 dan basladigi icin biraz bir ekledik
